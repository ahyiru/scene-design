...
import {options, defaultOpts, tableCfg, ScreenHeader} from '../configs';

const {option1, option2, option3, option4, option5, option6, option7, option8, option9, option10, option11, option12, columns1, columns2, dataSource1, dataSource2} = options;
...
const Index = props => {
  ...
  return (
    <div style={{background: 'var(--pageBgColor)'}}>
