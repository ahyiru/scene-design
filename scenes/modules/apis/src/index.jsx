...
import {defProject, apiList} from '../configs';
...
const Index = props => {
  ...
  const [result, update, pageChange, searchList] = useHandleList(listApiFn, {projectId: defProject._id}, {current: pageParams?.current, size: pageParams?.size});
